...
urlpatterns = [
    ...
    path(
        "storage/<int:pk>/labels/<str:axis>/",
        StorageLabelsView.as_view(),
        name="storage-labels",
    ),
    ...
    path(
        ...
        name="wine-ai-upload-poll",
    ),
    path(
        "wine/ai/status/<str:token>/existing/",
        WineAiExistingMatchView.as_view(),
        name="wine-ai-existing-match",
    ),
    ...
    path("wines/map/data", WineMapDataView.as_view(), name="wine-map-data"),
